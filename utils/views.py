...
class MathView(discord.ui.View):
    ...
    @discord.ui.button(style=discord.ButtonStyle.green, label="\N{DIVISION SIGN}", row=1)
    ...
    @discord.ui.button(style=discord.ButtonStyle.green, label="\N{MULTIPLICATION SIGN}", row=2)
