...
class Profile(Cog, description='A cog that generates fake profile info'):
    ...
    def fake_profile(self):
        ...
        prof = {'job': 'Acupuncturist', 'company': 'Howard, Reed and Peters', 'ssn': '014-36-1839',
                'residence': '93557 Moreno Coves\nNancyborough, PA 96910',
                'current_location': (Decimal('-20.479780'), Decimal('112.773438')), 'blood_group': 'A+',
                'website': ['https://kelly.com/', 'https://www.frederick-hudson.info/', 'https://www.lee-garcia.info/'],
                'username': 'hartmantrevor', 'name': 'Alyssa Wallace', 'sex': 'F',
                'address': '49844 Amanda Common\nBlackwellstad, WI 49655', 'mail': 'patriciamiller@gmail.com',
