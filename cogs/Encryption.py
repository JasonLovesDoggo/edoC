...
class Encryption(
    commands.Cog, description="Need to send a super secret encrypted message we gotchu"
):
    ...
    async def decode_base32(self, ctx, *, text: commands.clean_content = None):
        ...
        try:
            await self.encryptout(
                ctx, "base32 -> Text", base64.b32decode(text.encode("utf-8"))
            )
        except Exception:
    ...
    async def decode_base64(self, ctx, *, text: commands.clean_content = None):
        ...
        try:
            await self.encryptout(
                ctx, "base64 -> Text", base64.urlsafe_b64decode(text.encode("utf-8"))
            )
        except Exception:
    ...
    async def encode_rot13(self, ctx, *, text: commands.clean_content = None):
        ...
        await self.encryptout(ctx, "Text -> rot13", codecs.decode(text, "rot_13"))
    ...
    async def decode_hex(self, ctx, *, text: commands.clean_content = None):
        ...
        try:
            await self.encryptout(
                ctx, "hex -> Text", binascii.unhexlify(text.encode("utf-8"))
            )
        except Exception:
    ...
    async def decode_base85(self, ctx, *, text: commands.clean_content = None):
        ...
        try:
            await self.encryptout(
                ctx, "base85 -> Text", base64.b85decode(text.encode("utf-8"))
            )
        except Exception:
    ...
    async def encode_ascii85(self, ctx, *, text: commands.clean_content = None):
        if not text:
            text = await self.detect_file(ctx)
        await self.encryptout(
            ctx, "Text -> ASCII85", base64.a85encode(text.encode("utf-8"))
        )
    ...
    async def decode_ascii85(self, ctx, *, text: commands.clean_content = None):
        ...
        try:
            await self.encryptout(
                ctx, "ASCII85 -> Text", base64.a85decode(text.encode("utf-8"))
            )
        except Exception:
    ...
    async def encode_to_morse(self, ctx, *, text: commands.clean_content = None):
        ...
        try:
            ...
            return await ctx.reply(
                f"Some of the characters in your message are not valid {ctx.author.mention}"
            )
    ...
    async def encode_to_binary(self, ctx, *, text: commands.clean_content = None):
        if not text:
            text = await self.detect_file(ctx)
        await self.encryptout(
            ctx, "Text -> binary", await self.sra.binary_encode(text.encode("utf-8"))
        )
    ...
    async def decode_to_binary(self, ctx, *, text: commands.clean_content = None):
        if not text:
            text = await self.detect_file(ctx)
        await self.encryptout(
            ctx, "Binary -> Text", await self.sra.binary_decode(text.encode("utf-8"))
        )
