...
class Skyblock(
    commands.Cog, description="Skyblock cog for.. SKYBLOCK related commands"
):
    ...
    async def balance(self, ctx, name, pname=None):
        ...
        async with ctx.session.get(
            "https://sky.shiiyu.moe/api/v2/coins/" + name
        ) as api:
            data = await api.json()
        max_bal = 0
        purse = 0
        ...
        embed = discord.Embed(
            title="Balance for " + name.capitalize(), color=random_color()
        )
    ...
    async def taming(self, ctx, name, pname=None):
        ...
        async with ctx.session.get(self.SkyV2 + name) as api:
            ...
            embed = discord.Embed(
                ...
                description="**Total Taming EXP: ** "
                + self.separator.format(round(int(xpForMax))),
                color=self.TamingColor,
            )
            # Contents of discord embed
            embed.set_author(
                name=f"Requested by {ctx.message.author}.",
            ...
            embed.add_field(
                name="**Taming Level**",
                value=(str(round(target_profile["data"]["levels"]["taming"]["level"])))
                + "/ 50",
            )
            embed.add_field(
                name="**Level with Progress**",
                value=(
                    round(
                        target_profile["data"]["levels"]["taming"]["levelWithProgress"],
                        2,
                    )
                ),
            )
            embed.add_field(
                name="**Remaining XP for Next Level**",
                value=self.separator.format(round(int(xpMax))),
                inline=False,
            )
            embed.add_field(
                name="**Ranking**",
                value=self.separator.format(
                    int(target_profile["data"]["levels"]["taming"]["rank"])
                ),
            )
            embed.add_field(
                name="**Xp Required for Max Level**",
                value=self.separator.format(round(int(of))),
            )
            await ctx.send(embed=embed)
    ...
    async def farming(self, ctx, name, pname=None):
        ...
        if levelCap == 60:
            embed.add_field(
                name=f"**XP Over Level {levelCap}**",
                value=(self.separator.format(round(xpForMax - xpCap)) + " Overflow XP"),
            )
            embed.add_field(
                name="**Ranking**",
                value=self.separator.format(
                    target_profile["data"]["levels"]["farming"]["rank"]
                ),
            )
            embed.add_field(
                name="**Level with Progress**",
                value=(
                    round(
                        target_profile["data"]["levels"]["farming"][
                            "levelWithProgress"
                        ],
                        2,
                    )
            ...
            embed.add_field(
                name=f"**Level Required to Level {levelCap}**",
    ...
    async def mining(self, ctx, name, pname=None):
        ...
        embed.add_field(
            name="**Mining Level**",
            value=(str(round(target_profile["data"]["levels"]["mining"]["level"])))
            + "/ 60",
        )
        embed.add_field(
            name="**Level with Progress**",
            value=(
                round(
                    target_profile["data"]["levels"]["mining"]["levelWithProgress"], 2
                )
            ),
        )
        embed.add_field(
        ...
        embed.add_field(
            name="**Ranking**",
            value=self.separator.format(
                int(target_profile["data"]["levels"]["mining"]["rank"])
            ),
        )
        embed.add_field(
            name="**Xp Required for Max Level**",
    ...
    async def combat(self, ctx, name, pname=None):
        ...
        embed.add_field(
            name="**Combat Level**",
            value=(str(round(target_profile["data"]["levels"]["combat"]["level"])))
            + "/ 60",
        )
        embed.add_field(
            name="**Level with Progress**",
            value=(
                round(
                    target_profile["data"]["levels"]["combat"]["levelWithProgress"], 2
                )
            ),
        )
        embed.add_field(
        ...
        embed.add_field(
            name="**Ranking**",
            value=self.separator.format(
                int(target_profile["data"]["levels"]["combat"]["rank"])
            ),
        )
        embed.add_field(
            name="**Xp Required for Max Level**",
    ...
    async def foraging(self, ctx, name, pname=None):
        ...
        embed = discord.Embed(
            ...
            url=f"{self.SkyShiiyuStats}{name}/{pname}",
            description="**Total Foraging EXP: ** "
            + self.separator.format(round(int(xpForMax))),
        ...
        embed.add_field(
            name="**Foraging Level**",
            value=(str(round(target_profile["data"]["levels"]["foraging"]["level"])))
            + "/ 50",
        )
        embed.add_field(
            name="**Level with Progress**",
            value=(
                round(
                    target_profile["data"]["levels"]["foraging"]["levelWithProgress"], 2
                )
            ),
        )
        embed.add_field(
        ...
        embed.add_field(
            name="**Ranking**",
            value=self.separator.format(
                int(target_profile["data"]["levels"]["foraging"]["rank"])
            ),
        )
        embed.add_field(
            name="**Xp Required for Max Level**",
    ...
    async def fishing(self, ctx, name, pname=None):
        ...
        embed.add_field(
            name="**Fishing Level**",
            value=(str(round(target_profile["data"]["levels"]["fishing"]["level"])))
            + "/ 50",
        )
        embed.add_field(
            name="**Level with Progress**",
            value=(
                round(
                    target_profile["data"]["levels"]["fishing"]["levelWithProgress"], 2
                )
            ),
        )
        embed.add_field(
        ...
        embed.add_field(
            name="**Ranking**",
            value=self.separator.format(
                int(target_profile["data"]["levels"]["fishing"]["rank"])
            ),
        )
        embed.add_field(
            name="**Xp Required for Max Level**",
    ...
    async def enchanting(self, ctx, name, pname=None):
        ...
        embed = discord.Embed(
            ...
            url=f"{self.SkyShiiyuStats}{name}/{pname}",
            description="**Total Enchanting EXP: ** "
            + self.separator.format(round(int(xpForMax))),
        ...
        embed.add_field(
            ...
            value=(str(round(target_profile["data"]["levels"]["enchanting"]["level"])))
            + "/ 60",
        )
        embed.add_field(
            name="**Level with Progress**",
            value=(
                round(
                    target_profile["data"]["levels"]["enchanting"]["levelWithProgress"],
                    2,
                )
            ),
        )
        ...
        embed.add_field(
            name="**Ranking**",
            value=self.separator.format(
                int(target_profile["data"]["levels"]["enchanting"]["rank"])
            ),
        )
        embed.add_field(
            name="**Xp Required for Max Level**",
    ...
    async def alchemy(self, ctx, name, pname=None):
        ...
        embed.add_field(
            name="**Alchemy Level**",
            value=(str(round(target_profile["data"]["levels"]["alchemy"]["level"])))
            + "/ 60",
        )
        embed.add_field(
            name="**Level with Progress**",
            value=(
                round(
                    target_profile["data"]["levels"]["alchemy"]["levelWithProgress"], 2
                )
            ),
        )
        embed.add_field(
        ...
        embed.add_field(
            name="**Ranking**",
            value=self.separator.format(
                int(target_profile["data"]["levels"]["alchemy"]["rank"])
            ),
        )
        embed.add_field(
            name="**Xp Required for Max Level**",
    ...
    async def carpentry(self, ctx, name, pname=None):
        ...
        embed = discord.Embed(
            ...
            url=f"{self.SkyShiiyuStats}{name}/{pname}",
            description="**Total Carpentry EXP: ** "
            + self.separator.format(round(int(xpForMax))),
        ...
        embed.add_field(
            name="**Carpentry Level**",
            value=(str(round(target_profile["data"]["levels"]["carpentry"]["level"])))
            + "/ 50",
        )
        embed.add_field(
            name="**Level with Progress**",
            value=(
                round(
                    target_profile["data"]["levels"]["carpentry"]["levelWithProgress"],
                    2,
                )
            ),
        )
        ...
        embed.add_field(
            name="**Ranking**",
            value=self.separator.format(
                int(target_profile["data"]["levels"]["carpentry"]["rank"])
            ),
        )
        embed.add_field(
            name="**Xp Required for Max Level**",
    ...
    @commands.command(
        name="runecrafting", description="Shows your Runecrafting statistics."
    )
    async def runecrafting(self, ctx, name, pname=None):
        ...
        embed = discord.Embed(
            ...
            url=f"{self.SkyShiiyuStats}{name}/{pname}",
            description="**Total Runecrafting EXP: ** "
            + self.separator.format(round(int(xpForMax))),
        ...
        embed.add_field(
            name="**Runecrafting Level**",
            value=(
                str(round(target_profile["data"]["levels"]["runecrafting"]["level"]))
            )
            + "/ 25",
        )
        embed.add_field(
            ...
            value=(
                round(
                    target_profile["data"]["levels"]["runecrafting"][
                        "levelWithProgress"
                    ],
                    2,
                )
        ...
        embed.add_field(
            name="**Ranking**",
            value=self.separator.format(
                int(target_profile["data"]["levels"]["runecrafting"]["rank"])
            ),
        )
        embed.add_field(
            name="**Xp Required for Max Level**",
    ...
    @commands.command(
        name="dungeons",
        aliases=["dungeon", "catacombs", "cata"],
    ...
    async def dungeons(self, ctx, name, pname=None):
        ...
        healer = target_profile["data"]["dungeons"]["classes"]["healer"]["experience"][
            "level"
        ]
        mage = target_profile["data"]["dungeons"]["classes"]["mage"]["experience"][
            "level"
        ]
        tank = target_profile["data"]["dungeons"]["classes"]["tank"]["experience"][
            "level"
        ]
        bers = target_profile["data"]["dungeons"]["classes"]["berserk"]["experience"][
            "level"
        ]
        archer = target_profile["data"]["dungeons"]["classes"]["archer"]["experience"][
            "level"
        ]
        fe = (
            target_profile["data"]["dungeons"]["catacombs"]["floors"]["0"]["stats"][
                "tier_completions"
            ]
            if "0" in target_profile["data"]["dungeons"]["catacombs"]["floors"]
            else 0
        )
        f1 = (
            target_profile["data"]["dungeons"]["catacombs"]["floors"]["1"]["stats"][
                "tier_completions"
            ]
            if "1" in target_profile["data"]["dungeons"]["catacombs"]["floors"]
            else 0
        )
        f2 = (
            target_profile["data"]["dungeons"]["catacombs"]["floors"]["2"]["stats"][
                "tier_completions"
            ]
            if "2" in target_profile["data"]["dungeons"]["catacombs"]["floors"]
            else 0
        )
        f3 = (
            target_profile["data"]["dungeons"]["catacombs"]["floors"]["3"]["stats"][
                "tier_completions"
            ]
            if "3" in target_profile["data"]["dungeons"]["catacombs"]["floors"]
            else 0
        )
        f4 = (
            target_profile["data"]["dungeons"]["catacombs"]["floors"]["4"]["stats"][
                "tier_completions"
            ]
            if "4" in target_profile["data"]["dungeons"]["catacombs"]["floors"]
            else 0
        )
        f5 = (
            target_profile["data"]["dungeons"]["catacombs"]["floors"]["5"]["stats"][
                "tier_completions"
            ]
            if "5" in target_profile["data"]["dungeons"]["catacombs"]["floors"]
            else 0
        )
        f6 = (
            target_profile["data"]["dungeons"]["catacombs"]["floors"]["6"]["stats"][
                "tier_completions"
            ]
            if "6" in target_profile["data"]["dungeons"]["catacombs"]["floors"]
            else 0
        )
        f7 = (
            target_profile["data"]["dungeons"]["catacombs"]["floors"]["7"]["stats"][
                "tier_completions"
            ]
            if "7" in target_profile["data"]["dungeons"]["catacombs"]["floors"]
            else 0
        )
        ...
        embed = discord.Embed(
            ...
            + (
                str(
                    round(
                        target_profile["data"]["dungeons"]["catacombs"]["level"]["xp"],
                        2,
                    )
                )
            ),
        ...
        embed.add_field(
            ...
            value=str(
                target_profile["data"]["dungeons"]["catacombs"]["level"]["level"]
            ),
        )
        embed.add_field(
            name="**EXP Until Next Level**",
            value=str(
        ...
        if target_profile["data"]["dungeons"]["catacombs"]["visited"]:
            embed.add_field(
                name="**Highest Floor\nIn Catacombs**",
                value=str(
                    target_profile["data"]["dungeons"]["catacombs"]["highest_floor"]
                )
                .replace("_", " ")
                .replace("f", "F"),
                inline=False,
        ...
        if target_profile["data"]["dungeons"]["master_catacombs"]["visited"]:
            embed.add_field(
                name="**Highest Floor\nIn Master Mode**",
                value=str(
                    target_profile["data"]["dungeons"]["master_catacombs"][
                        "highest_floor"
                    ]
                )
                .replace("_", " ")
                .replace("floor", "Master"),
                inline=True,
            )
    ...
    async def slayers(self, ctx, name, pname=None):
        ...
        t1eman = (
            target_profile["data"]["slayers"]["enderman"]["kills"]["1"]
            if "1" in target_profile["data"]["slayers"]["enderman"]["kills"]
            else 0
        )
        t2eman = (
            target_profile["data"]["slayers"]["enderman"]["kills"]["2"]
            if "2" in target_profile["data"]["slayers"]["enderman"]["kills"]
            else 0
        )
        t3eman = (
            target_profile["data"]["slayers"]["enderman"]["kills"]["3"]
            if "3" in target_profile["data"]["slayers"]["enderman"]["kills"]
            else 0
        )
        t4eman = (
            target_profile["data"]["slayers"]["enderman"]["kills"]["4"]
            if "4" in target_profile["data"]["slayers"]["enderman"]["kills"]
            else 0
        )

        t1sven = (
            target_profile["data"]["slayers"]["wolf"]["kills"]["1"]
            if "1" in target_profile["data"]["slayers"]["wolf"]["kills"]
            else 0
        )
        t2sven = (
            target_profile["data"]["slayers"]["wolf"]["kills"]["2"]
            if "2" in target_profile["data"]["slayers"]["wolf"]["kills"]
            else 0
        )
        t3sven = (
            target_profile["data"]["slayers"]["wolf"]["kills"]["3"]
            if "3" in target_profile["data"]["slayers"]["wolf"]["kills"]
            else 0
        )
        t4sven = (
            target_profile["data"]["slayers"]["wolf"]["kills"]["4"]
            if "4" in target_profile["data"]["slayers"]["wolf"]["kills"]
            else 0
        )

        t1tara = (
            target_profile["data"]["slayers"]["spider"]["kills"]["1"]
            if "1" in target_profile["data"]["slayers"]["spider"]["kills"]
            else 0
        )
        t2tara = (
            target_profile["data"]["slayers"]["spider"]["kills"]["2"]
            if "2" in target_profile["data"]["slayers"]["spider"]["kills"]
            else 0
        )
        t3tara = (
            target_profile["data"]["slayers"]["spider"]["kills"]["3"]
            if "3" in target_profile["data"]["slayers"]["spider"]["kills"]
            else 0
        )
        t4tara = (
            target_profile["data"]["slayers"]["spider"]["kills"]["4"]
            if "4" in target_profile["data"]["slayers"]["spider"]["kills"]
            else 0
        )

        t1reve = (
            target_profile["data"]["slayers"]["zombie"]["kills"]["1"]
            if "1" in target_profile["data"]["slayers"]["zombie"]["kills"]
            else 0
        )
        t2reve = (
            target_profile["data"]["slayers"]["zombie"]["kills"]["2"]
            if "2" in target_profile["data"]["slayers"]["zombie"]["kills"]
            else 0
        )
        t3reve = (
            target_profile["data"]["slayers"]["zombie"]["kills"]["3"]
            if "3" in target_profile["data"]["slayers"]["zombie"]["kills"]
            else 0
        )
        t4reve = (
            target_profile["data"]["slayers"]["zombie"]["kills"]["4"]
            if "4" in target_profile["data"]["slayers"]["zombie"]["kills"]
            else 0
        )
        t5reve = (
            target_profile["data"]["slayers"]["zombie"]["kills"]["5"]
            if "5" in target_profile["data"]["slayers"]["zombie"]["kills"]
            else 0
        )
        ...
        embed = discord.Embed(
            ...
            url=f"{self.SkyShiiyuStats}{name}/{pname}",
            description="**Total Slayer EXP:** "
            + self.separator.format(int(target_profile["data"]["slayer_xp"]))
            + "XP"
            + "\n ***Total Coins Spent on Slayers: ***"
            + self.separator.format(
                int(target_profile["data"]["slayer_coins_spent"]["total"])
            )
            + " coins",
        ...
        # Contents of discord embed
        embed.set_author(
            name=f"Requested by {ctx.message.author.display_name}.",
            icon_url=ctx.message.author.display_avatar.url,
        )
        embed.set_thumbnail(url=self.McHeads + name)
        embed.timestamp = ctx.message.created_at
        ...
        embed.add_field(
            ...
            value="Level "
            + str(target_profile["data"]["slayers"]["zombie"]["level"]["currentLevel"]),
        )
        embed.add_field(
            name="**Revenant Horror \nGathered XP**",
            value=str(
                self.separator.format(
                    target_profile["data"]["slayers"]["zombie"]["level"]["xp"]
                )
            )
            + "XP",
        )
        embed.add_field(
            name="**Coins Spent on \nRevenant Slayer**",
            value=self.separator.format(
                int(target_profile["data"]["slayer_coins_spent"]["zombie"])
            )
            + " Coins",
        )
        embed.add_field(
            name="Revenant Horror Kills:",
            value="```prolog\nT1: "
            + str(t1reve)
            + "\nT2: "
            + str(t2reve)
        ...
        embed.add_field(
            ...
            value="Level "
            + str(target_profile["data"]["slayers"]["spider"]["level"]["currentLevel"]),
        )
        embed.add_field(
            name="**Tarantula Broodfather \nGathered XP**",
            value=str(
                self.separator.format(
                    target_profile["data"]["slayers"]["spider"]["level"]["xp"]
                )
            )
            + "XP",
        )
        embed.add_field(
            name="**Coins Spent on \nTarantula Slayer**",
            value=self.separator.format(
                int(target_profile["data"]["slayer_coins_spent"]["spider"])
            )
            + " Coins",
        )
        embed.add_field(
            name="Tarantula Broodfather Kills:",
            value="```prolog\nT1: "
            + str(t1tara)
            + "\nT2: "
            + str(t2tara)
        ...
        embed.add_field(
            ...
            value="Level "
            + str(target_profile["data"]["slayers"]["wolf"]["level"]["currentLevel"]),
        )
        embed.add_field(
            name="**Sven Packmaster \nGathered XP**",
            value=str(
                self.separator.format(
                    target_profile["data"]["slayers"]["wolf"]["level"]["xp"]
                )
            )
            + "XP",
        )
        embed.add_field(
            name="**Coins Spent on \nSven Slayer**",
            value=self.separator.format(
                int(target_profile["data"]["slayer_coins_spent"]["wolf"])
            )
            + " Coins",
        )
        embed.add_field(
            name="Sven Packmaster Kills:",
            value="```prolog\nT1: "
            + str(t1sven)
            + "\nT2: "
            + str(t2sven)
        ...
        embed.add_field(
            ...
            value="Level "
            + str(
                target_profile["data"]["slayers"]["enderman"]["level"]["currentLevel"]
            ),
        )
        embed.add_field(
            name="**Voidgloom Seraph \nGathered XP**",
            value=str(
                self.separator.format(
                    target_profile["data"]["slayers"]["enderman"]["level"]["xp"]
                )
            )
            + "XP",
        )
        embed.add_field(
            name="**Coins Spent on \nVoidgloom Slayer**",
            value=self.separator.format(
                int(target_profile["data"]["slayer_coins_spent"]["enderman"])
            )
            + " Coins",
        )
        embed.add_field(
            name="Voidgloom Seraph Kills:",
            value="```prolog\nT1: "
            + str(t1eman)
            + "\nT2: "
            + str(t2eman)
