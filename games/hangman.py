...
words = ['conversation', 'bowtie', 'skateboard', 'penguin', 'hospital', 'player', 'kangaroo',
         ...
         'excellent', 'telescope', 'python', 'government', 'pineapple', 'volcano', 'alcohol', 'dad',
         'mailman', 'nature', 'dashboard', 'science', 'computer', 'circus', 'earthquake', 'bathroom',
         'toast', 'football', 'cowboy', 'mattress', 'translate', 'entertainment', 'glasses', 'easter', 'egg',
         'download', 'water', 'violence', 'whistle', 'alligator', 'independence', 'pizza', 'programing'
         ...
         'mushroom', 'student', 'mathematics', 'instruction', 'newspaper', 'gingerbread', 'coding',
