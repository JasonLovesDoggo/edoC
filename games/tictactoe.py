...
CACHED_MOVES = {
    ":x:": {
        ...
        (None, None, None, None, None, ":o:", None, None, None): (
            (None, None, ":x:", None, None, ":o:", None, None, None),
            None,
        ),
    ...
    ":o:": {
        ...
        (None, ":x:", None, None, None, None, None, None, None): (
            (":o:", ":x:", None, None, None, None, None, None, None),
            None,
        ),
        ...
        (None, None, None, ":x:", None, None, None, None, None): (
            (":o:", None, None, ":x:", None, None, None, None, None),
            None,
        ),
        (None, None, None, None, ":x:", None, None, None, None): (
            (":o:", None, None, None, ":x:", None, None, None, None),
        ...
        (None, None, None, None, None, ":x:", None, None, None): (
            (None, None, ":o:", None, None, ":x:", None, None, None),
            None,
        ),
        (None, None, None, None, None, None, ":x:", None, None): (
            (None, None, None, None, ":o:", None, ":x:", None, None),
            None,
        ),
        (None, None, None, None, None, None, None, ":x:", None): (
            (None, ":o:", None, None, None, None, None, ":x:", None),
            None,
        ),
...
get_available_moves = lambda board: [
    index_to_col_row(idx) for idx, item in enumerate(board) if item is None
]
...
def play(board, player, col, row):
    ...
    if (
        ...
        or board[board_index(col, row)] is not None
    ):
        raise IllegalMove
    board = (
        board[0 : board_index(col, row)]
        + (player,)
...
def board_winner(board):
    ...
    for row in range(0, 3):
        if (
            board[board_index(0, row)]
            == board[board_index(1, row)]
            == board[board_index(2, row)]
        ):
            return board[board_index(0, row)]

    for col in range(0, 3):
        if (
            board[board_index(col, 0)]
            == board[board_index(col, 1)]
            == board[board_index(col, 2)]
        ):
            return board[board_index(col, 0)]

    if (
        board[board_index(0, 0)] == board[board_index(1, 1)] == board[board_index(2, 2)]
        or board[board_index(2, 0)]
        == board[board_index(1, 1)]
        == board[board_index(0, 2)]
    ):
...
def _minimax(board, active_player, turn_player, depth):
    ...
    for available_move in available_moves:
        ...
        if next_winner is not None:
            ...
            scores.append(
                _minimax(next_board, active_player, opponent(turn_player), depth + 1)
            )
...
async def play_game(bot, ctx, chance_for_error=0.0):
    ...
    await ctx.send(
        "e.g.: To tick the middle cell in the top row: `1,2`\n`exit` to end game"
    )
